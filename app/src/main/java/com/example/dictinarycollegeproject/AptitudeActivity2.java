...
public class AptitudeActivity2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_aptitude_activity2);
	...
	case R.id.radioButton1:
		...
		btnokandnext.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in = new Intent(AptitudeActivity2.this,AptitudeActivity3.class);
				in.putExtra("k1",str);
				startActivity(in);
				finish();
...
//4991 A
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_aptitude_activity2, menu);
		return true;
	}
