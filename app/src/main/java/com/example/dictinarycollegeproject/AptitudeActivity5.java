...
public class AptitudeActivity5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_aptitude_activity5);
	...
	case R.id.radioButton1:
		...
		btnokandnext.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in = new Intent(AptitudeActivity5.this,ResultActivity.class);
				in.putExtra("k1",str);
				startActivity(in);
				finish();
...
//31 * 5/7   B
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_aptitude_activity5, menu);
		return true;
	}
