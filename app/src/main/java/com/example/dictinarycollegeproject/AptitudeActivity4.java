...
public class AptitudeActivity4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_aptitude_activity4);
	...
	case R.id.radioButton1:
		...
		btnokandnext.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in = new Intent(AptitudeActivity4.this,AptitudeActivity5.class);
				in.putExtra("k1",str);
				startActivity(in);
				finish();
...
//85   C
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_aptitude_activity4, menu);
		return true;
	}
